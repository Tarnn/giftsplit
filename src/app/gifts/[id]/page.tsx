            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-white mb-2 font-medium" htmlFor="message">
                      Message (Optional)
                    </label>
                    <textarea
                      id="message"
                      ...
                      rows={3}
                      maxLength={200}
                      className="w-full px-4 py-3 bg-[#1a1f4d]/30 text-white rounded-xl border border-white/10 focus:border-white/20 focus:outline-none focus:ring-2 focus:ring-blue-500/20 placeholder-white/40 transition-all duration-200 resize-none"
                    />
                    <p className="mt-1 text-sm text-white/40">
                      {200 - contributorMessage.length} characters remaining
                    </p>
                  </div>
                  ...
                  <div className="bg-[#1a1f4d]/30 rounded-xl p-6 border border-white/10 backdrop-blur-sm">
                    ...
                    <div className="space-y-4">
                      ...
                      {contributorMessage && (
                        <div className="flex justify-between text-white/60 items-center">
                          <span>Message</span>
                          <span className="font-medium text-white text-right max-w-[200px] truncate">{contributorMessage}</span>
                        </div>
                      )}
                      <div className="flex justify-between text-white/60 items-center">
                        <span>Amount</span>
